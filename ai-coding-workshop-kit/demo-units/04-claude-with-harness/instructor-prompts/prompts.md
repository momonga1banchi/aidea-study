...
Claude Desktop Codeで、ハーネスありの開発手順を見せます。

このファイルは講師だけが見ます。  
Claudeにはこのファイルを読ませず、`project/` の中だけを開いてください。

## 進め方

Claude Desktop Codeで、このデモ単位の `project/` を開きます。

```text
demo-units/04-claude-with-harness/project
```
...
- Claudeには、CLAUDE.mdでプロジェクトルールを渡している
