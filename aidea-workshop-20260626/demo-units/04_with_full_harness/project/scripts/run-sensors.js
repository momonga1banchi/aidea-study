...
const sensors = [['test','npm',['run','test']],['lint','npm',['run','lint']],['typecheck','npm',['run','typecheck']],['policy-boundary','npm',['run','sensor:architecture']],['api-response','npm',['run','sensor:api-response']]];
